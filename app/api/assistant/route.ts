...
5. If the user mentions any physical limitations, strollers, sensory overstimulation, or accessibility needs, prioritize highlighting the specific accessible gates (especially Gate 3 East Accessible) and the sensory room in Zone B.`;
    ...
    if (!apiKey || apiKey === "your_gemini_api_key_here") {
      ...
      } else if (lastMessage.includes("train") || lastMessage.includes("metro") || lastMessage.includes("transport") || lastMessage.includes("shuttle") || lastMessage.includes("bus")) {
      ...
      } else if (lastMessage.includes("hola") || lastMessage.includes("español") || lastMessage.includes("spanish")) {
